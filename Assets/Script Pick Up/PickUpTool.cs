...
/// <summary>
/// Ce script sert a pickup l'objet Tool pour les quests
...
public class PickUpTool : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetKeyDown(KeyCode.Space) && canInteract == true && playerQuest.quest.goal.questType == QuestType.GatheringTool)
        {
            playerQuest.ToolPickUp();
            Destroy(gameObject);
        }
    }
